...
With a Generational garbage collector we have a block of memory into which we are allocating our objects. This is our young generation.
\\
Notice that we also have an old generation, but there may be an object that may be alive, but may not be alive.
\end{frame}
